...
import org.variiance.vcall.jobmanager.Constraint;
...
import org.variiance.vcall.jobmanager.impl.CellServiceConstraintObserver;
import org.variiance.vcall.jobmanager.impl.ChangeNumberConstraint;
import org.variiance.vcall.jobmanager.impl.ChangeNumberConstraintObserver;
import org.variiance.vcall.jobmanager.impl.ChargingConstraint;
import org.variiance.vcall.jobmanager.impl.ChargingConstraintObserver;
import org.variiance.vcall.jobmanager.impl.DataRestoreConstraint;
import org.variiance.vcall.jobmanager.impl.DataRestoreConstraintObserver;
import org.variiance.vcall.jobmanager.impl.DecryptionsDrainedConstraint;
import org.variiance.vcall.jobmanager.impl.DecryptionsDrainedConstraintObserver;
import org.variiance.vcall.jobmanager.impl.NetworkConstraint;
import org.variiance.vcall.jobmanager.impl.NetworkConstraintObserver;
import org.variiance.vcall.jobmanager.impl.NetworkOrCellServiceConstraint;
import org.variiance.vcall.jobmanager.impl.NotInCallConstraint;
import org.variiance.vcall.jobmanager.impl.NotInCallConstraintObserver;
import org.variiance.vcall.jobmanager.impl.SqlCipherMigrationConstraint;
import org.variiance.vcall.jobmanager.impl.SqlCipherMigrationConstraintObserver;
import org.variiance.vcall.jobmanager.migrations.PushDecryptMessageJobEnvelopeMigration;
import org.variiance.vcall.jobmanager.migrations.PushProcessMessageQueueJobMigration;
import org.variiance.vcall.jobmanager.migrations.RecipientIdFollowUpJobMigration;
import org.variiance.vcall.jobmanager.migrations.RecipientIdFollowUpJobMigration2;
import org.variiance.vcall.jobmanager.migrations.RecipientIdJobMigration;
import org.variiance.vcall.jobmanager.migrations.RetrieveProfileJobMigration;
import org.variiance.vcall.jobmanager.migrations.SendReadReceiptsJobMigration;
import org.variiance.vcall.jobmanager.migrations.SenderKeyDistributionSendJobRecipientMigration;
import org.variiance.vcall.migrations.AccountConsistencyMigrationJob;
import org.variiance.vcall.migrations.AccountRecordMigrationJob;
import org.variiance.vcall.migrations.ApplyUnknownFieldsToSelfMigrationJob;
import org.variiance.vcall.migrations.AttachmentCleanupMigrationJob;
import org.variiance.vcall.migrations.AttributesMigrationJob;
import org.variiance.vcall.migrations.AvatarIdRemovalMigrationJob;
import org.variiance.vcall.migrations.AvatarMigrationJob;
import org.variiance.vcall.migrations.BackupJitterMigrationJob;
import org.variiance.vcall.migrations.BackupNotificationMigrationJob;
import org.variiance.vcall.migrations.BlobStorageLocationMigrationJob;
import org.variiance.vcall.migrations.CachedAttachmentsMigrationJob;
import org.variiance.vcall.migrations.ClearGlideCacheMigrationJob;
import org.variiance.vcall.migrations.DatabaseMigrationJob;
import org.variiance.vcall.migrations.DecryptionsDrainedMigrationJob;
import org.variiance.vcall.migrations.DeleteDeprecatedLogsMigrationJob;
import org.variiance.vcall.migrations.DirectoryRefreshMigrationJob;
import org.variiance.vcall.migrations.EmojiDownloadMigrationJob;
import org.variiance.vcall.migrations.EmojiSearchIndexCheckMigrationJob;
import org.variiance.vcall.migrations.IdentityTableCleanupMigrationJob;
import org.variiance.vcall.migrations.LegacyMigrationJob;
import org.variiance.vcall.migrations.MigrationCompleteJob;
import org.variiance.vcall.migrations.OptimizeMessageSearchIndexMigrationJob;
import org.variiance.vcall.migrations.PassingMigrationJob;
import org.variiance.vcall.migrations.PinOptOutMigration;
import org.variiance.vcall.migrations.PinReminderMigrationJob;
import org.variiance.vcall.migrations.PniAccountInitializationMigrationJob;
import org.variiance.vcall.migrations.PniMigrationJob;
import org.variiance.vcall.migrations.PreKeysSyncMigrationJob;
import org.variiance.vcall.migrations.ProfileMigrationJob;
import org.variiance.vcall.migrations.ProfileSharingUpdateMigrationJob;
import org.variiance.vcall.migrations.RebuildMessageSearchIndexMigrationJob;
import org.variiance.vcall.migrations.RecipientSearchMigrationJob;
import org.variiance.vcall.migrations.StickerAdditionMigrationJob;
import org.variiance.vcall.migrations.StickerDayByDayMigrationJob;
import org.variiance.vcall.migrations.StickerLaunchMigrationJob;
import org.variiance.vcall.migrations.StickerMyDailyLifeMigrationJob;
import org.variiance.vcall.migrations.StorageCapabilityMigrationJob;
import org.variiance.vcall.migrations.StorageServiceMigrationJob;
import org.variiance.vcall.migrations.StorageServiceSystemNameMigrationJob;
import org.variiance.vcall.migrations.StoryReadStateMigrationJob;
import org.variiance.vcall.migrations.StoryViewedReceiptsStateMigrationJob;
import org.variiance.vcall.migrations.Svr2MirrorMigrationJob;
import org.variiance.vcall.migrations.SyncDistributionListsMigrationJob;
import org.variiance.vcall.migrations.TrimByLengthSettingsMigrationJob;
import org.variiance.vcall.migrations.UpdateSmsJobsMigrationJob;
import org.variiance.vcall.migrations.UserNotificationMigrationJob;
import org.variiance.vcall.migrations.UuidMigrationJob;
