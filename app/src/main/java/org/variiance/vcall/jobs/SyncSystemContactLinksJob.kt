...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.org.variiance.vcall.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.variiance.vcall.call"
