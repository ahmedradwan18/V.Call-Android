...
import org.variiance.vcall.jobs.SmsSentJob;
...
public class SmsDeliveryListener extends BroadcastReceiver {
  ...
  public static final String SENT_SMS_ACTION      = "org.variiance.vcall.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION = "org.variiance.vcall.SendReceiveService.DELIVERED_SMS_ACTION";
