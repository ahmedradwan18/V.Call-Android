...
class AndroidCallConnectionService : ConnectionService() {
  ...
  companion object {
    ...
    const val KEY_RECIPIENT_ID = "org.variiance.vcall.RECIPIENT_ID"
    const val KEY_CALL_ID = "org.variiance.vcall.CALL_ID"
    const val KEY_VIDEO_CALL = "org.variiance.vcall.VIDEO_CALL"
  }
