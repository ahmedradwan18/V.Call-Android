...
import org.variiance.vcall.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link org.variiance.vcall.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
