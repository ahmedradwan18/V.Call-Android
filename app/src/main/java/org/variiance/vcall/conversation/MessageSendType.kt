...
import org.variiance.vcall.util.CharacterCalculator
import org.variiance.vcall.util.MmsCharacterCalculator
import org.variiance.vcall.util.PushCharacterCalculator
import org.variiance.vcall.util.SmsCharacterCalculator
import org.variiance.vcall.util.dualsim.SubscriptionInfoCompat
import org.variiance.vcall.util.dualsim.SubscriptionManagerCompat
...
sealed class MessageSendType(
  ...
  object SignalMessageSendType : MessageSendType(
    ...
    backgroundColorRes = R.color.core_terquaz,
