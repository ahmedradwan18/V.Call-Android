...
import org.variiance.vcall.util.Environment;
...
public final class InternalValues extends SignalStoreValues {
  ...
  /**
   * Show detailed recipient info in the {@link org.variiance.vcall.components.settings.conversation.InternalConversationSettingsFragment}.
   */
