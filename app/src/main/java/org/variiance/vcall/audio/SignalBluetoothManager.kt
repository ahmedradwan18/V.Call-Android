...
package org.variiance.vcall.audio
...
import org.variiance.vcall.util.safeUnregisterReceiver
import org.variiance.vcall.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.variiance.vcall.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.variiance.vcall.webrtc.audio.SignalAudioManager].
 */
