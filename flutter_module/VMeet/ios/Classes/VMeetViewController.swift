...
class VMeetViewController: UIViewController {
    ...
    fileprivate var vMeetView: JitsiMeetView?
    ...
    var vMeetUserInfo = JitsiMeetUserInfo()
    ...
    func openVMeet() {
        cleanUp()
        // create and configure v.meet view
        let vMeetView = JitsiMeetView()
        
        
        vMeetView.delegate = self
        self.vMeetView = vMeetView
        let options = JitsiMeetConferenceOptions.fromBuilder { (builder) in
            builder.room = self.roomName
            builder.serverURL = self.serverUrl            
            builder.userInfo = self.vMeetUserInfo
        ...
        vMeetView.join(options)
        
        // Enable v.meet view to be a view that can be displayed
        // on top of all the things, and let the coordinator to manage
        // the view state and interactions
        pipViewCoordinator = PiPViewCoordinator(withView: vMeetView)
